...
image::../images/konzept/sonderzeichen_klasse_transtext.png[width=35%,align="center"]
...
image::../images/konzept/sonderzeichen_transkription.png[pdfwidth=50%,width=50%,align="center"]
