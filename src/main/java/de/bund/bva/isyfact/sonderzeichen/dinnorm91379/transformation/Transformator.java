...
public interface Transformator {
     ...
     *
     * @param zeichenkette   The string to transform
     * @param maximaleLaenge The maximum length of the string
     *
     ...
     *
     * @param kategorieListe the allowed expressions of the character category
     *
     ...
     *
     * @param zeichenkette   the string to be checked
     * @param kategorieListe the list of categories
     *
     ...
     *
     * @param regel    Number of the rule to be evaluated.
     * @param text     String from which the substring to be tested originates.
     * @param position Position of the substring in the text.
