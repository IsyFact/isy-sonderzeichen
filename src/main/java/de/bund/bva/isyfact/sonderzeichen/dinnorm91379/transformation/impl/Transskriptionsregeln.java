...
public final class Transskriptionsregeln {
     ...
     *
     * @param text         The text in which to examine the position.
     * @param position     The position to be examined.
     * @param trennzeichen The set of all characters that are not considered part of a word.
     *
     ...
     *
     * @param text         The text in which to examine the position.
     * @param position     The starting position of the substring to be examined.
     * @param laenge       The length of the substring to be examined.
     * @param trennzeichen The set of all characters that are not considered part of a word.
     *
     ...
     * @param position     The starting position of the substring to be examined.
     * @param laenge       The length of the substring to be examined.
     * @param pruefzeichen The set of all characters that are not considered part of a word.
     *
     * @return true if the substring is in the middle of a word, otherwise false
     */
